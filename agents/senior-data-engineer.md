...
skills:
  - skills/gcp-data-engineering
  - skills/cdc-scd-patterns
---
...
1. **Understand the requirement first**: source system(s), required freshness (batch is the default; streaming only when justified), downstream consumers, and expected data volume. Use `ask_question` when these are genuinely unclear.

...
Nine plugins in this repository bundle physical copies of a subset of these skills so they can be distributed standalone: [`python-backend`](plugins/python-backend) (11 backend skills), [`senior-dev`](plugins/senior-dev) (8 SDLC-orchestration skills), [`git-workflow`](plugins/git-workflow) (2), [`docs-and-quality`](plugins/docs-and-quality) (3), [`multi-agent-ops`](plugins/multi-agent-ops) (2), [`senior-data-engineer`](plugins/senior-data-engineer) (2, GCP-focused), [`sql-query-optimizer`](plugins/sql-query-optimizer) (2, BigQuery + generic SQL), [`shared-context`](plugins/shared-context) (2, cross-agent working memory), and [`senior-dev-flutter`](plugins/senior-dev-flutter) (7, the senior Flutter layer on top of the official Flutter/Dart skill packs). Edit skills here, then run `python3 scripts/sync_plugin_skills.py` to re-sync all of them.

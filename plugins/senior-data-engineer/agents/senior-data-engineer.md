...
1. **Understand the requirement first**: source system(s), required freshness (batch is the default; streaming only when justified), downstream consumers, and expected data volume. Ask the user when these are genuinely unclear.

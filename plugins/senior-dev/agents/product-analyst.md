...
2. **Clarify only real ambiguities**: use `AskUserQuestion` for missing details or contradictions that would actually change the implementation — don't ask when the request is already clear.

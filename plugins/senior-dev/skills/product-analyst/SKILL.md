...
2. Cross-reference existing system code or specifications (search the codebase, read related files) to determine existing patterns.
...
- Ask the user precise, option-based clarifying questions.
...
Scale the deliverable to the request: a small, well-scoped change needs a short note (goal, scope, acceptance criteria). Reserve the full PRD template below for new features or system-level work.

...
1. Read the Architecture Blueprint and Product Requirements before writing code, when they exist. For a small, self-contained fix with no such handoff, read the surrounding code directly instead.

...
| :--- | :--- | :--- |
| [**clean-code-and-principles.md**](rules/clean-code-and-principles.md) | `clean-code-and-principles` | SOLID, DRY, KISS, YAGNI, and anti-hallucination quality rules. |
| [**context-and-token-optimization.md**](rules/context-and-token-optimization.md) | `context-and-token-optimization` | Context budgeting, file line bounds, deterministic local script offloading. |
| [**conventional-commits.md**](rules/conventional-commits.md) | `conventional-commits` | Branch safety, protected branches, Conventional Commits 1.0.0. |
| [**deployment-restrictions.md**](rules/deployment-restrictions.md) | `deployment-restrictions` | Protected deployment CLI commands, pre-deploy quality gates. |
| [**documentation-and-diagrams.md**](rules/documentation-and-diagrams.md) | `documentation-and-diagrams` | Signature sync, non-obvious "why" comments, clean Mermaid syntax. |
| [**loop-engineering-workflow.md**](rules/loop-engineering-workflow.md) | `loop-engineering-workflow` | 9-stage engineering execution cycle (/spec to /ship) with dynamic orchestrator sizing and subagent delegation. |
| [**pull-requests.md**](rules/pull-requests.md) | `pull-requests` | PR size limit (<200 lines), mandatory agent self-audit checklist. |
| [**secure-coding-and-secrets.md**](rules/secure-coding-and-secrets.md) | `secure-coding-and-secrets` | Credential exclusions, OWASP Top 10 injection & auth rules. |
| [**skills-and-mcp-awareness.md**](rules/skills-and-mcp-awareness.md) | `skills-and-mcp-awareness` | Mandatory skill/MCP tool prioritization over custom scripts. |
| [**tdd-best-practices.md**](rules/tdd-best-practices.md) | `tdd-best-practices` | TDD Red-Green-Refactor, AAA pattern, anti-tampering rules. |
| [**testing-after-changes.md**](rules/testing-after-changes.md) | `testing-after-changes` | Empirical runtime verification, zero victory without `exit code 0`. |

...
| [**loop-engineering-workflow.md**](file:///Users/jggomez/Documents/jggomez/code/skills-programming-ai/rules/loop-engineering-workflow.md) | `loop-engineering-workflow` | 7-stage cycle scaled to task size, subagent delegation, manager quality gates. |
